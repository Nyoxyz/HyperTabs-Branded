            ...
            node.attrs.forEach(attr => {
                ...
                switch(handler) {
                    ...
                    case 'newTabParse':
                        ...
                        switch(attr.value) {
                            case "_blank":
                                node.setAttribute("onclick", "window.parent.newTab(window.normalizeRelativeURL(this.getAttribute('corrosion-href')));return false");
                                break;
                            case "_parent" || "_top":
                                attr.value = "_self"
                                break;
        ...
        return [
            ...
            { 
                ...
                childNodes: [
                    {
                        nodeName: '#text',
                        value: `window.normalizeRelativeURL=(function(u){var a=document.createElement("a");a.href=u;return a.href});window.open=(function(u,v,w){return window.parent.newTab(window.normalizeRelativeURL(u),v,w)});`
                    },
                ], 
                attrs: [],
            }
