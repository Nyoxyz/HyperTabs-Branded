...
var i = 1;
  ...
  class ChromeTabs {
    ...
    removeTab(tabEl) {
      let tabParent = tabEl.parentNode;
      if (tabEl === this.activeTabEl) {
        ...
        if (tabEl.nextElementSibling || tabEl.previousElementSibling) setinfo(+(tabEl.nextElementSibling || tabEl.previousElementSibling).getAttribute('ifd') + 1);
      }
      ...
      this.layoutTabs()
      this.setupDraggabilly()
      if (!tabParent.childElementCount) document.getElementById('createTab').click()
    }
